...
typealias ptrdiff_t Clonglong
typealias size_t Clonglong
...
typealias GLcharARB Cuchar
typealias GLhandleARB Cuint
typealias GLhalfARB Cushort
typealias GLhalfNV Cushort
typealias int8_t Cuchar
...
typealias int_least8_t Cuchar
typealias int_least16_t Cshort
typealias int_least32_t Cint
typealias int_least64_t Clonglong
typealias uint_least8_t Cuchar
typealias uint_least16_t Cushort
typealias uint_least32_t Cuint
typealias uint_least64_t Culonglong
typealias int_fast8_t Cuchar
typealias int_fast16_t Clonglong
typealias int_fast32_t Clonglong
typealias int_fast64_t Clonglong
typealias uint_fast8_t Cuchar
typealias uint_fast16_t Culonglong
typealias uint_fast32_t Culonglong
typealias uint_fast64_t Culonglong
typealias intptr_t Clonglong
typealias uintptr_t Culonglong
typealias intmax_t Clonglong
typealias uintmax_t Culonglong
typealias __gwchar_t Cint
export GLenum
export GLboolean
export GLbitfield
export GLvoid
